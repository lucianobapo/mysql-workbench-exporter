...
/**
 * ErpNET\App\Models\Doctrine\Entities\Attachment
 *
 * @ORM\Entity(repositoryClass="AttachmentRepository")
 * @ORM\Table(name="attachments", indexes={@ORM\Index(name="attachments_mandante_index", columns={"mandante"}), @ORM\Index(name="attachments_order_id_index", columns={"order_id"}), @ORM\Index(name="attachments_deleted_at_index", columns={"deleted_at"})})
 */
class Attachment
{
    /**
     ...
     *
     * @param integer $id
     * @return \ErpNET\App\Models\Doctrine\Entities\Attachment
     */
    ...
    {
        return array('id', 'created_at', 'updated_at', 'deleted_at', 'mandante', 'order_id', 'file');
    }
}