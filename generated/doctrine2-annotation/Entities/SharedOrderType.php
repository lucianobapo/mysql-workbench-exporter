...
class SharedOrderType
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Order", mappedBy="sharedOrderType")
     * @ORM\JoinColumn(name="id", referencedColumnName="type_id", nullable=false)
     */
    protected $orders;
    ...
    {
        return array('id', 'created_at', 'updated_at', 'deleted_at', 'tipo', 'descricao');
    }
}